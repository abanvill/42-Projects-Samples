...
class Search extends React.Component
{
  ...
  componentWillMount () {
    ...
    if (!state.authentication.user.status.isSigned)
      ...
      this.props.onPageLoad(this.props.history)
  }
    ...
    return (
      <div className="col-md-10 col-md-offset-1">
        <div className="col-md-4">
          ...
          <FilterForm onFilter={(filtered) => { this.onFilter(filtered) }} self={self} users={this.state.user.allUsers} />
        </div>
        <div className="col-md-8">
          <div className="page-header col-md-12">
            <h1><i className="fa fa-female" /><i className="fa fa-male" />{' '}{'All users'}</h1>
          </div>
